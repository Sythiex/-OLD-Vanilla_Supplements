package com.sythiex.vanillasupplements.world;

import java.util.Random;

import com.sythiex.vanillasupplements.VanillaSupplements;
import com.sythiex.vanillasupplements.blocks.BlockBushVS;
...
public class WorldGenVS implements IWorldGenerator
{
	...
	/**
	 * determines if the block is OK to replace during world generation (returns false for liquids)
	 * 
	 * @param world
	 * @param x
	 * @param y
